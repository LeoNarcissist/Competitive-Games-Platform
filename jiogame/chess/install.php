...
function createTableGames(){
	...
	$Result = $dbc->query($SQLCreateTableGames);
        return $Result;
}
...
function createTableHistory(){
	...
	$Result = $dbc->query($SQLCreateTableHistory);
        return $Result;
}
...
function createTableMessages() {
	...
	$Result = $dbc->query($SQLCreateTableMessages);
        return $Result;
}
...
function createTablePieces(){
	...
	$Result = $dbc->query($SQLCreateTablePieces);
        return $Result;
}
...
function createTablePlayers(){
	...
	$Result = $dbc->query($SQLCreateTablePlayers);
        return $Result;
}

function tablePlayersHasLastAccessField() {
	$SQLUpdateTablePlayers = "EXPLAIN players;";
	$Result = $dbc->query($SQLUpdateTablePlayers);
	while($Row=mysql_fetch_row($Result)){
		if($Row[0]=="lastAccess"){
			return true;
		}
...
function createTablePreferences() {
	...
	$Result = $dbc->query($SQLCreateTablePreferences);
        return $Result;
}
...
function createTableCommunication() {
	...
	$Result = $dbc->query($SQLCreateTableCommunication);
        return $Result;
}
...
function insertSampleFieldIntoCommunications() {
	...
	$Result = $dbc->query($SQLInsertIntoCommunication);
        return $Result;
}
